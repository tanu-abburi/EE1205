...
\begin{lstlisting}
$https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/tanusha.wav
\end{lstlisting}
...
\lstinputlisting{codes/tan.py}\label{prob:audio_filter_problem}
\item
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/b.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/b.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/d.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/c.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/a.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/e.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/f.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/g.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/h.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/i.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
    ...
    &+b\brak{2}x\brak{n-2}+b\brak{3}x\brak{n-3} + b\brak{4}x\brak{n-4} 
\end{align}
Difference Equation is given by :
\begin{align}
	&y(n) - \brak{3.66}y(n - 1) + \brak{5.03}y(n - 2) \nonumber \\
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/j.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/tanu-abburi/EE1205/blob/main/Audio-Filter/codes/k.py
\end{lstlisting}
\begin{figure}[H]
\centering
